...
import io.idempotency.IdempotencyTestUtils;
import io.idempotency.Message;
import io.idempotency.MessageListener;
import io.idempotency.MessageService;
import io.idempotency.MessagingIdempotencyConfig;
...
class IdempotencyMessagingItTest {
  ...
  public void testSaveAndRetrieveMessage() {
    ...
    // when
    messageService.save(IdempotencyTestUtils.createIdempotentMessage());

    // then
    assertThat(
        messageService.find(IdempotencyTestUtils.createIdempotentContext()))
        .isNotNull();
  }
